...
public class FormStep4Activity extends NavigationActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        v = inflater.inflate(R.layout.activity_form_step4, null,false);
        drawer.addView(v,0);
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(hasText(edt)){
                    ...
                    intentnext.putExtra("dscuname", edt.getText().toString());

...
public class ResourceStep5 extends NavigationActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        v = inflater.inflate(R.layout.activity_resource_step5, null,false);
        drawer.addView(v,0);
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(hasText(edt)){
                    Intent intentnext = new Intent(getApplicationContext(), ResourceStep6.class);
                    ...
                    intentnext.putExtra("qtyintend", edt.getText().toString());

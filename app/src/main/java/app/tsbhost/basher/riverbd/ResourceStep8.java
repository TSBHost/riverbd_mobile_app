...
public class ResourceStep8 extends NavigationActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        v = inflater.inflate(R.layout.activity_resource_step8, null,false);
        drawer.addView(v,0);
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(hasText(edt)){
                    ...
                    intentnext.putExtra("contrrep", edt.getText().toString());
